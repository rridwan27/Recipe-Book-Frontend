    ...
    <div className=" py-6 px-4 md:px-10 transition-colors duration-300">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        >
          ...
          <span className="white-text dark:text-gray-700 ">SpiceSpoon</span>
        </Link>

        {/* Contact Info */}
        <div className="flex flex-col md:flex-row items-center gap-4 text-sm font-medium">
          <div className="flex items-center gap-2 white-text dark:text-gray-700">
      ...
      {/* Bottom Text */}
      <div className="text-center text-xs font-semibold white-text dark:text-gray-700">
